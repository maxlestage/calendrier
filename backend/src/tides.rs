...
/// French reference ports. Restrictable via the TIDE_PORTS env var
/// (comma-separated keys, e.g. "brest,saint-malo").
pub const PORTS: [Port; 4] = [
    Port { key: "brest", name: "Brest", lat: 48.3828, lon: -4.4956 },
    Port { key: "saint-malo", name: "Saint-Malo", lat: 48.6397, lon: -2.0257 },
    Port { key: "la-rochelle", name: "La Rochelle", lat: 46.1558, lon: -1.1517 },
    Port { key: "nice", name: "Nice", lat: 43.6954, lon: 7.2790 },
];

/// Ports enabled for this deployment (all by default).
